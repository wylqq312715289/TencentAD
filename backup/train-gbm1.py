...
model_path = "./model/my_gbm1.model" #模型保存的地址
...
def train_gbm_model(samples_df, libsvm_dump_path, libsvm_test_dump_path,mode="train"):
    ...
    bst = lgb.train(params, dtrain, num_boost_round=156, valid_sets=dtest, early_stopping_rounds=5 )
...
def lightGBM_make_submission():
    ...
    pre_df = sub_samples_df[['instanceID','prob']]
